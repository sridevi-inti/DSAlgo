...
public class ArrayPage extends TestBase {
	...
	@FindBy(xpath = "//*[contains(text(),'Arrays in Python')]")
	WebElement ArrayPython_btn;
	@FindBy(xpath = "//*[contains(text(),'Arrays Using List')]")
	WebElement ArrayList_btn;
	@FindBy(xpath = "//*[contains(text(),'Basic Operations in Lists')]")
	WebElement BasicOperationList_btn;
	@FindBy(xpath = "//a[@href='applications-of-array']")
	WebElement ApplicationArray_btn;
	@FindBy(xpath = "//a[@href='/question/1']")
	WebElement btn_searchthearray;
	@FindBy(xpath = "//a[@href='/question/2']")
	WebElement btn_maxconsecutiveones;
	@FindBy(xpath = "//a[@href='/question/3']")
	WebElement btn_findnumberswithevennumberofdigits;
	@FindBy(xpath = "//a[@href='/question/4']")
	WebElement btn_squaresofasortedarray;
	@FindBy(className = "CodeMirror-lines")
	WebElement editorInput;
	@FindBy(xpath = "//pre[@id='output']")
	WebElement editorOutput;
